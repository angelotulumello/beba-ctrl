...
OPP_EXPERIMENTER_ID = 0xBEBABEBA
...
# Opp experimenter fields
oxm_types = [
    oxm_fields.OppExperimenter('global_state', 0, type_desc.Int4),
    oxm_fields.OppExperimenter('state', 1, type_desc.Int4),
    oxm_fields.OppExperimenter('condition0', 2, type_desc.Int1),
    oxm_fields.OppExperimenter('condition1', 3, type_desc.Int1),
    oxm_fields.OppExperimenter('condition2', 4, type_desc.Int1),
    oxm_fields.OppExperimenter('condition3', 5, type_desc.Int1),
    oxm_fields.OppExperimenter('condition4', 6, type_desc.Int1),
    oxm_fields.OppExperimenter('condition5', 7, type_desc.Int1),
    oxm_fields.OppExperimenter('condition6', 8, type_desc.Int1),
    oxm_fields.OppExperimenter('condition7', 9, type_desc.Int1),
    oxm_fields.OppExperimenter('timestamp', 10, type_desc.Int4),
    oxm_fields.OppExperimenter('random', 11, type_desc.Int2),
    oxm_fields.OppExperimenter('pkt_len', 12, type_desc.Int2)
]

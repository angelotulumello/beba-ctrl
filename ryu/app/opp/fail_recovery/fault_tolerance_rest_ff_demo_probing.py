#Versione Opp che sfrutta la tecnica del Fast Failover al posto dei Global States
...
class OppFaultToleranceRestAPI(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto.OFP_VERSION]
    _CONTEXTS = {
        'wsgi': WSGIApplication,
        'fault_tolerance' : fault_tolerance.OppFaultTolerance
    }
    
    def __init__(self, *args, **kwargs):
        super(OppFaultToleranceRestAPI, self).__init__(*args, **kwargs)
        wsgi = kwargs['wsgi']

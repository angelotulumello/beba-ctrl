...
class OppEvolution(app_manager.RyuApp):
	...
	def switch_features_handler(self, event):
		...
		actions = [ofparser.OFPActionOutput(ofproto.OFPP_FLOOD),
					...
					oppparser.OFPExpActionSetDataVariable(table_id=0, opcode=oppproto.OPCODE_SUM, output_fd_id=0, operand_1_hf_id=1, operand_2_gd_id=3)]
		...
		req = oppparser.OFPExpMsgSetCondition(
				...
				table_id=0,
				condition_id=3,
				condition=oppproto.CONDITION_LT,
				operand_1_hf_id=1,
				operand_2_fd_id=0
			)
		datapath.send_msg(req)

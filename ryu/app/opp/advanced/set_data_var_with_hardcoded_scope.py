...
class OppEvolution(app_manager.RyuApp):
	...
	def switch_features_handler(self, event):
		...
		actions = [oppparser.OFPExpActionSetDataVariable(table_id=0, opcode=oppproto.OPCODE_SUM, output_fd_id=0, operand_1_fd_id=0, operand_2_cost=1, fields=[ofproto.OXM_OF_ETH_DST,ofproto.OXM_OF_ETH_SRC]),
		ofparser.OFPActionOutput(ofproto.OFPP_FLOOD)]
		self.add_flow(datapath=datapath,
				table_id=0,
				priority=0,

...
import ryu.ofproto.opp_v1_0 as osp
import ryu.ofproto.opp_v1_0_parser as osparser
...
class OSDdosMitigation(app_manager.RyuApp):
    ...
    def switch_features_handler(self, event):
        """
        Switch sent his features, check if OPP is supported.
        """

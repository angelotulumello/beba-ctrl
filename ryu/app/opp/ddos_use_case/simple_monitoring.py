...
LOG = logging.getLogger('app.opp.simple_monitoring')


class SimpleMonitoring(selective_monitoring.OppSelectiveMonitoring):
    ...
    def _request_stats(self, datapath):
        req = oppparser.OFPExpStateStatsMultipartRequestAndDelete(datapath, table_id=0)

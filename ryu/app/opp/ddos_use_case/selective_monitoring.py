...
LOG = logging.getLogger('app.opp.selective_monitoring')

LOG.info("Feature monitored: ipv4_src")

class OppSelectiveMonitoring(app_manager.RyuApp):
    def __init__(self, *args, **kwargs):
        super(OppSelectiveMonitoring, self).__init__(*args, **kwargs)
    ...
    def switch_features_handler(self, event):
        ...
        actions = [oppparser.OFPExpActionIncState(table_id=0)]

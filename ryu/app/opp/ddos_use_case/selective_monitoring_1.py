...
LOG = logging.getLogger('app.opp.selective_monitoring_1')
...
class OppSelectiveMonitoring_1(app_manager.RyuApp):
    def __init__(self, *args, **kwargs):
        super(OppSelectiveMonitoring_1, self).__init__(*args, **kwargs)
        ...
        for table in range(len(features) + 1):  # Add 1 for the Mac learning table
            ...
            if table != 6:
                ...
                if table == 0:
                    ...
                    actions = [oppparser.OFPExpActionIncState(table_id=table)]
                ...
                for i in range(1, N + 1):
                    for s in range(N + 1):
                        ...
                        if s == 0:
                            ...
                            out_port = s
                        actions = [oppparser.OFPExpActionSetState(state=i, table_id=table, hard_timeout=10),
